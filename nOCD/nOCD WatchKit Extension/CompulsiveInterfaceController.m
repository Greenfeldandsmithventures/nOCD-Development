//
//  CompulsiveInterfaceController.m
//  nOCD
//
...
#import "CompulsiveInterfaceController.h"

@interface CompulsiveInterfaceController ()

@end

@implementation CompulsiveInterfaceController
...
- (void)setupTable
{
    NSArray *data = [[NSArray alloc] initWithObjects:@"Washing My Hands", @"Mentally Checking Past Events", @"Add a New Theme", nil];
...
{
    [self pushControllerWithName:@"ObsessionalInterfaceController" context:@{@"fromCompulsive":@1}];
}
